...
package Checksims.algorithm.linesimilarity;
...
import Checksims.token.TokenTypeMismatchException;
...
public final class LineSimilarityChecker implements SimilarityDetector {
	...
	/**
	 * Internal class for record-keeping - used to record a line at a specific
	 * location in a submission.
	 */
	 ...
	 * @throws TokenTypeMismatchException Thrown comparing two submissions with
	 *                                    different token types
	 * @throws InternalAlgorithmError     Thrown on error obtaining a hash algorithm
	 *                                    instance
	 */
	@Override
