...
public class RacketList extends RacketExpression {
	 ...
	 * @throws InvalidFormatException Was given an invalidly formatted file and
	 *                                could not parse a proper list
	...
	/**
	 * Insert the list into the tree map if it has a height less than or equal to
	 * the leaf depth
	 * 
	...
	/**
	 * Returns the number of matching children between this list and another list,
	 * making sure to skip the child it is coming from
	 * Using a hashmap would make this O(n) algorithm instead, but I found that
	 * since we're dealing with low values of n
	 ...
	 * For a list this is defined and the sum of the leaves value of the children
	 * and itself
	 * 
	 * @param leavesMap
	...
	/**
	 * hashCode for a Racket List, equivalent to the hashCode of its first element
	 * times the size of the list
	 * 
	 * @return the hashCode
	 */
	public int hashCode() {
	...
	/**
	 * Returns a string representation of the list what is the children wrapped in
	 * paranthesis
	 * 
