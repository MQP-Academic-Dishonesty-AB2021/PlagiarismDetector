...
public class RacketTree {
     ...
     * @throws InvalidFormatException There was an error parsing the file into a tree
     */
     ...
     * @throws InvalidFormatException The file was not able to be parsed into a Racket Tree
     */
     ...
     * @throws InvalidFormatException The file could not be parsed into valid racket code
     */
     ...
     * Equivalent to the sum of the similarity value of its children, normalized for the number of leaves in the tree
     * @param leavesMap The leaves hash
     * @return The sum of similarity values of its children normalized for the number of leaves it has
     */
    ...
    /**
     * Setter for leaf depth attribute, using a setter because if it changes we have to recalculate the hash, and if it
