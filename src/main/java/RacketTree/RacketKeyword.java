...
public class RacketKeyword extends RacketExpression {
     ...
     * @throws InvalidFormatException Was given an improperly formatted file and was not able to read the keyword
    ...
    /**
     * Returns true iff the other object is a RacketKeyword with the same keyword value
