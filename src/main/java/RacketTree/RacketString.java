...
public class RacketString extends RacketExpression {
	 ...
	 * @throws InvalidFormatException Given an improperly formatted file and could
	 *                                not finish the string
	...
	/**
	 * Returns true iff the other object is a RacketString with the same string
	 * value
	 * 
	...
	/**
	 * The hashCode is the same as the underlying string but added one to avoid
	 * collisions with RacketAtoms
	 * 
	 * @return the hashCode
	 */
	@Override
	public int hashCode() {
		return this.str.hashCode() + 1;
	}
